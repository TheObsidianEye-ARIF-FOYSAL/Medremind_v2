...
/// First screen shown to a signed-out user: app pitch + BDApps pricing
/// disclosure, per BDApps' subscription UI guidelines (rate card, feature
/// list, "Subscribe & Continue" CTA before the phone number step). Mirrors
/// the pre-Firestore SubscriptionScreen this app used to have.
          ...
          child: Column(children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Subscribe & Continue',
            ...
            Container(
              ...
              child: Row(children: [
                Icon(Icons.verified_rounded, color: TagColors.taken, size: 20),
                const SizedBox(width: 10),
                Expanded(
                  child: Text(
                    '৳2 +VAT+SD+SC/day\n'
                    'via your mobile operator billing (BDApps)',
                    style: theme.textTheme.bodySmall?.copyWith(color: muted),
                  ),
                ),
              ]),
